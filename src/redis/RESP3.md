...
在前面的文章 `Redis：我是如何与客户端进行通信的`中，我们介绍过RESP V2版本协议的规范，RESP的全程是`Redis Serialization Protocol`，基于这个实现简单且解析性能优秀的通信协议，Redis的服务端与客户端可以通过底层命令的方式进行数据的通信。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/24cc676508a24f2f8a38bce097c95c57~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c219cfed2d474883901acbc4e60b6493~tplv-k3u1fbpfcp-zoom-1.image)
